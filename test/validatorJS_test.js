...
describe("Validation functions", function() {
  ...
  describe("isEmailAddress", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isEmailAddress,
        "missing .isEmailAddress method on validator object"
      );
    });
    it("should return true for a valid email with a dot in the left side", function() {
      assert.isTrue(
        v.isEmailAddress("joe.momma@mail.com"),
        "should validate email with '.' in left side of address"
      );
    });

    it("should return false for an email with no TLD", function() {
      assert.isFalse(
        v.isEmailAddress("joe.momma@mail"),
        "an email with no top-level domain should not validate"
      );
    });

    it("should return false for an email with no @ symbol", function() {
      assert.isFalse(
        v.isEmailAddress("joe.momma.co"),
        "an email with no @ symbol should not validate"
      );
    });

    it("should return false for an email with no string before the @ symbol", function() {
      assert.isFalse(
        v.isEmailAddress("@fake.com"),
        "an email with no string before the @ symbol should not validate"
      );
    });
  });
  ...
  describe("isPhoneNumber", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isPhoneNumber,
        "missing .isPhoneNumber method on validator object"
      );
    });
    it("UK phone 11 digit", function() {
      assert.equal(
        v.isPhoneNumber("020 2546 7889"),
        true,
        "11-digit phone number - UK"
      );
    });

    it("USA phone 10 digit", function() {
      assert.equal(
        v.isPhoneNumber("12549683215"),
        true,
  ...
  describe("isBeforeDate", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isBeforeDate,
        "missing .isBeforeDate method on validator object"
      );
    });
  ...
  describe("isAfterDate", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isAfterDate,
        "missing .isAfterDate method on validator object"
      );
    });
  ...
  describe("isBeforeToday", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isBeforeToday,
        "missing .isBeforeToday method on validator object"
      );
    });
  ...
  describe("isAfterToday", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isAfterToday,
        "missing .isAfterToday method on validator object"
      );
    });
  ...
  describe("isEmpty", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isEmpty,
        "missing .isEmpty method on validator object"
      );
    });
  ...
  describe("isTrimmed", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isTrimmed,
        "missing .isTrimmed method on validator object"
      );
    });
  ...
  describe("contains", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.contains,
        "missing .contains method on validator object"
      );
    });
    ...
    it("should return true if input contains one or more words in the words array", function() {
      assert.isTrue(
        v.contains('"Definitely," he said in a matter-of-fact tone.', [
          "matter",
          "definitely"
        ])
      );
  ...
  describe("lacks", function() {
    ...
    it("should return false if input contains one or more words in the words array", function() {
      assert.isFalse(
        v.lacks('"Definitely," he said in a matter-of-fact tone.', [
          "matter",
          "definitely"
        ])
      );
  ...
  describe("isComposedOf", function() {
    ...
    it("should return true if the input string contains only strings found within the strings array.", function() {
      assert.isTrue(
        v.isComposedOf("I am ready.", ["I", "I'm", "am", "not", "ready"])
      );
    });
    ...
    it("should return true if the input string contains only strings found within the strings array.", function() {
      assert.isTrue(
        v.isComposedOf("Iamnotready.", ["I", "I'm", "am", "not", "ready"])
      );
    });
  ...
  describe("isOfLengthOrLessThan", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isOfLengthOrLessThan,
        "missing .isOfLengthOrLessThan method on validator object"
      );
    });
  ...
  describe("isOfLengthOrGreaterThan", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isOfLengthOrGreaterThan,
        "missing .isOfLengthOrGreaterThan method on validator object"
      );
    });
  ...
  describe("lessWordsThan", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.lessWordsThan,
        "missing .lessWordsThan method on validator object"
      );
    });
  ...
  describe("moreWordsThan", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.moreWordsThan,
        "missing .moreWordsThan method on validator object"
      );
    });
  ...
  describe("isNumberBetween", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isNumberBetween,
        "missing .isNumberBetween method on validator object"
      );
    });
  ...
  describe("isAlphanumeric", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isAlphanumeric,
        "missing .isAlphanumeric method on validator object"
      );
    });
  ...
  describe("isCreditCard", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isCreditCard,
        "missing .isCreditCard method on validator object"
      );
    });
  ...
  describe("isHex", function() {
    ...
    it("should return false for invalid shorthand hexadecimal color (too many characters)", function() {
      assert.isFalse(v.isHex("#fff3"));
    });
  });
  ...
  describe("isHSL", function() {
    ...
    it("should return false for input with missing required chars: hsl(270, 0.6, 0.7", function() {
      assert.isFalse(v.isHSL("hsl(270, 0.6, 0.7"));
    });
    ...
    // optional robustness tests
    it("should return false for a out of range input: hsl(270deg, 600%, 700%)", function() {
      assert.isFalse(v.isHSL("hsl(270deg, 600%, 700%)"));
    });
  ...
  describe("isColor", function() {
    it("should be a function", function() {
      assert.isFunction(
        v.isColor,
        "missing .isColor method on validator object"
      );
    });
